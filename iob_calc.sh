...
#to multiply all settings by 100000 (was previously 10000)
...
if [[ $last_meal_bolus_iob_for_if_then -gt 0 ]]
then
echo "You still have a meal IOB of $last_meal_bolus_iob_1 units of insulin"
else 
echo 'You have no meal IOB'
fi

if [[ $last_correction_bolus_iob_for_if_then -gt 0 ]]
then
echo "You still have a correction IOB of $last_correction_bolus_iob_1 units of insulin"
else
echo 'You have no correction IOB'
fi
